...
import numpy as np
import torch
from closd.diffusion_planner.utils.parser_util import edit_args
...
def main():
    ...
    fps = 12.5 if args.dataset == 'kit' else 30 if args.dataset == 'h1' else 20
    ...
    if args.apply_cond:
        model_kwargs['y']['clean_motion'] = copy.deepcopy(model_kwargs['y']['inpainted_motion'])
        model_kwargs['y']['keyframe_mask'] = copy.deepcopy(model_kwargs['y']['inpainting_mask'][:, [0]])

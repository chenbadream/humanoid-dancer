...
def get_opt(opt_path, device, hml_type=None):
    ...
    if opt.dataset_name == 't2m':
        ...
        data_dir = 'new_joint_vecs_global_root' if hml_type == 'global_root' else 'new_joint_vecs'
        ...
        assert opt.hml_type is None # "KIT dataset does not support global representation"
